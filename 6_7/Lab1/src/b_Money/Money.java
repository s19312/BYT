...
public class Money implements Comparable {
	...
	public String toString() {
		return (double)this.amount/100 + " " + currency.getName();
	}
	...
	public int compareTo(Object other) {
		...
		if(  money.universalValue().intValue() == universalValue().intValue() ){
			return 1;
		}else if(money.universalValue().intValue() > universalValue().intValue() ) {
			return -1;
		}
		return 0;
	}
